...
function validCompleted() {
  return {
    ...
    athleteContext: { ageYears: 47, estimationSex: "male",
      height: meas(70, "in"), weight: meas(203.2, "lb"), waist: meas(36.5, "in", { protocol: "compound_standard_waist_v1" }) },
    ...
    result: { bodyFat: { low: 20.5, high: 23.0, best: 21.8, displayRange: "20.5–23%", displayBest: "About 22%" },
      bodyComposition: { weight: 203.2, weightUnit: "lb", estimatedFatMass: 39.7, estimatedLeanMass: 142.5, estimatedFatFreeMass: 142.5 },
