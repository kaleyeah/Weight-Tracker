...
| M8 | Sync rework (design v7 contract, approved round 8) | CLIENT EVIDENCE ACCEPTED (round 19, 128 browser cases vs a modeled server; candidate uncommitted in the compound-app working copy, extracted for every release). Real-PocketBase gate PASSED (round 21: real CAS hook/ledger, field+account isolation, real-client restart recovery, verified disposable cleanup). Current gate: RELEASE PACKAGING review. Publication, production mutation, and lockdown remain gated |
