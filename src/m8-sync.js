...
/* THE DESTRUCTIVE-EMPTY INVARIANT.
   ...
   Nothing is lost. A genuine clean slate still exists: the refusal raises the
   conflict banner, which shows both copies, requires exporting both, and then
   takes his choice. That IS the confirmation — informed, deliberate, and with
   the data off the device first — and it was already built.
