...
(async()=>{
  ...
  await ctx.addInitScript(()=>{
    ...
    localStorage.setItem('wl_v1',JSON.stringify({
      ...
      weights:[{date:'2026-07-20',weight:189.2},{date:'2026-07-27',weight:186.8},
               {date:'2026-07-30',weight:185.6},{date:'2026-08-02',weight:184.0},{date:'2026-08-03',weight:183.6}],
